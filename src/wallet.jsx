...
const wallet = () => {
  return (
    <div style={styles.profileStyle}>
      ...
      `}</style>
      <div style={{ width: '1440px', height: '900px', minHeight: '900px', position: 'relative', margin: '0 auto' }}>
        ...
        {/* Recharge Credits label under the box */}
        <span
          style={{
            position: 'absolute',
            top: '350px',
        ...
        {/* Search bar under Recharge Credits */}
        <div
          style={{
            position: 'absolute',
            top: '400px',
        ...
        >
          <input
            type="text"
            placeholder="Write number of credits"
            style={{
              width: '100%',
              height: '100%',
              border: 'none',
